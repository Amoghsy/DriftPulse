...
export default function Dashboard() {
  ...
  /** File Upload and Analyze handler */
  const handleFileUpload = useCallback(async (event) => {
    ...
    try {
      ...
      setAnalyzeMsg(err?.message || "ML pipeline analysis failed.")
    } finally {
      setAnalyzing(false)
      ...
      <div className="page-header">
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "0.75rem", flexWrap: "wrap" }}>
          ...
          <label
            ...
            title="Upload IoT telemetry CSV to run AI analysis"
          >
            <RefreshCw size={15} className={analyzing ? "spin-icon" : ""} />
            {analyzing ? "Analyzing…" : "Upload Dataset"}
            <input
              type="file"
              accept=".csv"
              style={{ display: "none" }}
