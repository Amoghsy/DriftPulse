...
export default function Login({ onLogin }) {
  ...
  const handleCredentials = async (e) => {
    ...
    try {
      ...
      // mark as OTP-verified for the local/frontend-only auth flow
      ...
      <div className="lp-box">
        <div className="lp-form-container">
          <div className="lp-inner">
            ...
            {/* Frontend-only login — no external Firebase required */}
...
function getPasswordResetErrorMessage(error) {
  ...
  return "Unable to send reset email right now. Try again later."
}
